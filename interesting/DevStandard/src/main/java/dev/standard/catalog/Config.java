...
public final class Config {
    ...
    // Component 文件名
    public static final String              COMPONENT_DIR_NAME   = "component";
    // Component 项目本地路径
    public static final String              COMPONENT_LOCAL_PATH = USER_DIR + File.separator + COMPONENT_DIR_NAME;
    // Component 文件目录注释
    public static final Map<String, String> sComponentCatalogMap = new HashMap<>();
    ...
    // Core 文件本地路径
    public static final String              CORE_LOCAL_PATH     = USER_DIR + "/component/" + CORE_DIR_NAME;
    // Core 文件目录注释
    ...
    // Module 文件本地路径
    public static final String              MODULE_LOCAL_PATH     = USER_DIR + "/component/" + MODULE_DIR_NAME;
    // Module 文件目录注释
    ...
    // Libs 文件本地路径
    public static final String              LIBS_LOCAL_PATH     = USER_DIR + "/component/" + LIBS_DIR_NAME;
    // Libs 文件目录注释
    ...
    static {
        ...
        sComponentCatalogMap.put("component", "根目录");
        sComponentCatalogMap.put(".core", "核心基础整合库");
        sComponentCatalogMap.put(".libs", "通用 Library、第三方库 clone 差异化修改");
        sComponentCatalogMap.put(".module", "具体功能模块，被主体应用 ( 壳 ) 所依赖使用");
        ...
        sCoreCatalogMap.put(".libs.lib_utils", "通用工具库");
        ...
        sModuleCatalogMap.put(".module_aaa", "演示 AAA Module");
